...
const SendBar = ({ id, sid, socket }) => {
  ...
  return (
    <div className="w-full inset-0 bg-black/30 opacity-100  p-2 flex items-center gap-2">
      <input
        type="text"
        placeholder="Type a message"
        value={sendMessage}
        onChange={(e) => setSendMessage(e.target.value)}
        className="flex-1 px-4 py-2 border border-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-amber-50/90"
      />
      <button
